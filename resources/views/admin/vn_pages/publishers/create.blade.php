        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Thêm mới nhà xuất bản</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            {{Breadcrumbs::render('admin.publishers.create')}}
                        </ol>
                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="name" class="form-control" id="name-input"
                                            placeholder="Enter publisher name" value="{{old('name')}}">
                                        @error('name')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" name="slug" class="form-control" id="slug-input"
                                            placeholder="Enter publisher slug" value="{{old('slug')}}">
                                        @error('slug')
                                        <p class="text-danger">{{$message}}</p>
                                        @enderror
                                    </div>
