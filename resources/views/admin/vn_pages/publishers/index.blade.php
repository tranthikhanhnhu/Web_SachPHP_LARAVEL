        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Danh sách nhà xuất bản</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            {{Breadcrumbs::render('admin.publishers')}}
                        </ol>
                    </div>
                    ...
                    <div class="card-header">
                        <div class="row g-4 align-items-center">
                            <div class="col-sm-auto">
                                <div>
                                    <h4 class="card-title mb-0 flex-grow-1">Nhà xuất bản</h4>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <a href="{{route('admin.publishers.create')}}" class="btn btn-primary">Thêm mới nhà xuất bản</a>
                                    ...
                                    <div class="search-box ms-2">
                                        <input type="text" class="form-control" id="search-input"
                                            placeholder="Search for publishers..." value="{{ request()->keyword }}">
                            ...
                            <div class="table-responsive table-card">
                                <table class="table align-middle table-nowrap table-striped-columns mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($publishers as $publisher)
                                            <tr>
                                                ...
                                                <td>{{ $publisher->products->count() }}</td>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.publishers.show', ['publisher' => $publisher->id]) }}"
                                                        type="button" class="btn btn-sm btn-light">Chi tiết</a>
                                                    <a href="{{ route('admin.publishers.edit', ['publisher' => $publisher->id]) }}"
                                                        type="button" class="btn btn-sm btn-secondary">Sửa</a>
                                                    <form class="d-inline"
                                                        action="{{ route('admin.publishers.changeStatus', ['publisher' => $publisher->id]) }}"
                                                        method="POST">
                                                        @csrf
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            <td colspan="8">
                                                {{ $publishers->links('admin.pagination.custom') }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
