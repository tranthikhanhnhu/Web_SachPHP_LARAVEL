    ...
    <div class="container">
                            ...
                            @if (Auth::check() && $user_bought_this_product)
                                <a class="write-review" href="#"
                                    onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><i
                                        class="fa fa-pencil"></i> Viết nhận xét</a>
                            @endif
                    </div>
                    <ul class="list-unstyled short-desc">
                        <li><span class="desc">Nhà xuất bản:</span><a href="">{{ $product->publisher->name }}</a>
                        </li>
                        <li><span class="desc">Mã sản phẩm:</span>{{ $product->id }}</li>
                        <li><span class="desc">Hiệu lực:</span>{{ $product->quantity }} sản phẩm còn lại,
                            {{ calculateAvailability($product) }} hiện có sẵn</li>
                    </ul>
                    ...
                    <div id="product">
                        ...
                        <div class="product-rightinfo">
                            ...
                            <div class="form-group cart-block" style="display: flex">
                                <div class="col-3">
                                    <label class="control-label qty" for="rent-time-input">Thời gian thuê:</label>
                                </div>
                            ...
                            <div class="form-group cart-block" style="display: flex">
                                <div class="col-3">
                                    <label class="control-label qty" for="quantity-input">Số lượng:</label>
                                </div>
                                <div style="display: flex">
                            ...
                            <div class="form-group cart-block" style="display: flex">
                                <div class="col-3">
                                    <label class="control-label qty" for="total-input">Tổng:</label>
                                </div>
                                <div style="display: flex">
                                ...
                                @if (Auth::check())
                                    @if ($product->quantity > 0)
                                        <button type="button" id="button-cart"
                                            ...
                                            class="btn btn-primary btn-lg btn-block">Thêm vào giỏ hàng</button>
                                    @endif
                                    <button type="button" id="button-like"
                                        data-url="{{ route('client.addToLikedProducts', ['productId' => $product->id]) }}"
                                        class="btn btn-default wishlist"><i class="fa fa-heart"></i>
                                        Thêm vào danh sách yêu thích
                                        </button>
                                @else
                                    <a type="button" href="{{ route('login') }}"
                                        class="btn btn-primary btn-lg btn-block">Đăng nhập để thuê</a>
                                @endif
                            </div>
                    ...
                    <div class="content_product_block">
                        <div>
                            <div class="product-tabs" id="custom_tab">
                                <ul>
                                    <li><a class="first selected" href="#tab-1" style="display: inline;">Mô tả</a>
                                    </li>
                                    <li><a class="second" href="#tab-2" style="display: inline;">Kích thước sản phẩm</a>
                                    </li>
                                    <li><a class="third" href="#tab-3" style="display: inline;">Thông tin</a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="col-sm-12" id="tabs_info">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab-review" data-toggle="tab">Nhận xét
                ...
                <div class="tab-pane active" id="tab-description">
                                            ...
                                            @if (Auth::check() && Auth::user()->id === $review->user_id)
                                                <a
                                                    href="{{ route('client.products.deleteReview', ['review' => $review->id]) }}"><button
                                                        style="margin-left: 20px">Xóa</button>
                                            @endif
                                        </td></a>
                                    </tr>
                                    <tr>
                    ...
                    @if (Auth::check() && $user_bought_this_product)
                        <form class="form-horizontal" id="form-review" method="POST">
                            ...
                            <h4>Viết nhận xét như {{ Auth::user()->userInfo->last_name }}
