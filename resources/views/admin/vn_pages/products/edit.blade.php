                    ...
                    <div class="card-body">
                        <div class="live-preview">
                            <form action="{{ route('admin.products.update', ['product' => $product->id]) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="name-input" class="form-label">Tên sản phẩm</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="slug-input" class="form-label">Từ khóa</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="price-input" class="form-label">Giá</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="rentPriceInput1" class="form-label">Giá thuê 1 ngày</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="rentPriceInput7" class="form-label">Giá thuê 7 ngày</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="rentPriceInput30" class="form-label">Giá thuê 30 ngày</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="rentPriceInput90" class="form-label">Giá thuê 90 ngày</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="dateInput" class="form-label">Bố cục sách</label>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="originInput" class="form-label">Nguyên tác</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="dimensionsInput" class="form-label">Kích thước</label>
                                    </div>
                                    <div class="col-lg-2">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="numberOfPageInput" class="form-label">Tổng số trang</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="dateInput" class="form-label">Mặt trước sách</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="dateInput" class="form-label">Mặt sau sách</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="row mb-3">
                                    <div class="col-lg-3">
                                        <label for="dateInput" class="form-label">Ảnh sản phẩm</label>
                                    </div>
                                    <div class="col-lg-9">
