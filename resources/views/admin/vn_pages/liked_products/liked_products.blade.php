            ...
            <div id="content" class="col-sm-9">
                        ...
                        <table class="table table-bordered shopping-cart">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-left">Nhà xuất bản</td>
                                    <td class="text-right">Nguyên tác</td>
                ...
                <div class="buttons clearfix">
                    <div class="pull-left"><a
                            href="{{route('/')}}"
                            class="btn btn-primary">Tiếp tục mua sắm</a></div>
                    <div class="pull-right"><a
                            href="{{route('client.cart')}}"
                            class="btn btn-primary">Tới giỏ hàng</a></div>
                </div>
            </div>
        </div>
    </div>
