...
<body>
    ...
    <div id="layout-wrapper">
        ...
        @include('admin.vn_pages.sidebar')
    ...
    <!-- nouisliderribute js -->
    <script src="{{asset('backend/assets/libs/nouislider/nouislider.min.js')}}"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Mar 2023 22:13:52 GMT -->
