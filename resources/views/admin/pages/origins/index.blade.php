        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Origins List</h4>
                    ...
                    <div class="card-header">
                        <div class="row g-4 align-items-center">
                            <div class="col-sm-auto">
                                <div>
                                    <h4 class="card-title mb-0 flex-grow-1">Origins</h4>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="d-flex justify-content-sm-end">
                                    <a href="{{route('admin.origins.create')}}" class="btn btn-primary">Create Origins</a>
                                    ...
                                    <tbody>
                                        @foreach ($origins as $origin)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.origins.show', ['origin' => $origin->id]) }}"
                                                        type="button" class="btn btn-sm btn-light">Details</a>
                                                    <a href="{{ route('admin.origins.edit', ['origin' => $origin->id]) }}"
