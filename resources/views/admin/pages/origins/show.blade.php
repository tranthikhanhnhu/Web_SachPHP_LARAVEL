        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Origins Detail</h4>
        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-breviewless mb-0">
                                <tbody>
                                    <tr>
                                        <th class="ps-0" scope="row">Origin Name :</th>
                                        <td class="text-muted">{{ $origin->name }}</td>
                                    </tr>
                                    <tr>
                                        <th class="ps-0" scope="row">Origin Slug :</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-muted">{!! $origin->status == 1 ? '<span class="text-success">show</span>' : '<span class="text-danger">hidden</span>' !!}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="col-lg-12">
                <div class="hstack gap-2 justify-content-start">
                    <a href="{{route('admin.origins.edit', ['origin' => $origin->id])}}" type="submit" class="btn btn-primary">Edit</a>
