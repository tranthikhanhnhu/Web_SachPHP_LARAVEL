    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div id="content" class="col-sm-9">
                <h1>Register</h1>
                <p>Nếu bạn đã có tài khoản rồi thì vui lòng đăng nhập ở trang <a
                       style="text-decoration:underline" href="{{route('login')}}">đăng nhập</a>.</p>
                <form action="{{route('storeUser')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <fieldset id="account">
                        ...
                        <div class="form-group required">
                            <label class="col-sm-2 control-label" for="input-username">Tên người dùng</label>
                            <div class="col-sm-10">
