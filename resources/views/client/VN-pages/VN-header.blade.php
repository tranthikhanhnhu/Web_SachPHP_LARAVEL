        ...
        <div class="container">
            <div class="row">
                ...
                <div class="content_header_right">
                    <div>
                        <p><a href="{{route('/')}}">{{ is_null(Auth::user()) ? '' : Auth::user()->username . ',' }} Chào mừng bạn đến với tiệm sách của chúng tôi</a></p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div id="cart-products-container">
                                    <ul class="dropdown-menu pull-right cart-menu">
                                        @if (Auth::check())
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="text-right button-container">
                                                            <a href="{{ route('client.cart') }}"
                                                                class="btn-primary addtocart"><strong>Giỏ hàng</strong></a>
                                                        </div>
                                                </li>
                                            @else
                                                <li>
                                            ...
                                            @endif
                                        @else
                                            <a href="{{route('login')}}" class="btn btn-primary">Đăng nhập để xem giỏ hàng của bạn</a>
                                        @endif
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul class="list-inline">
                                <li class="dropdown myaccount"><a
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right myaccount-menu">
                                        ...
                                        <li><a href="{{ route('admin.index') }}">Trang admin</a></li>
                                        @endif
                                        @if (Auth::check())
                                        ...
                                        <li><a href="{{route('client.orderHistory')}}">Lịch sử đặt hàng</a></li>
                                        <li><a href="{{route('client.users.edit')}}">Tài khoản của tôi</a></li>
